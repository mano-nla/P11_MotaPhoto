...
function theme_enqueue_styles() {
    ...
    wp_enqueue_script('lightbox-script', get_stylesheet_directory_uri() . '/js/photo-lightbox.js', array(), filemtime(get_stylesheet_directory() . '/js/photo-lightbox.js'), true);
}
